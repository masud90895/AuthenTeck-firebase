...
const Profile = () => {
  ...
  return (
    <div className='flex justify-center mt-20'>
      <div className='max-w-lg flex-col p-8 sm:flex sm:space-x-6 border border-gray-200 rounded-lg shadow-2xl text-gray-900'>
        <div className='flex-shrink-0 w-[100%] mb-6 h-44 sm:h-32  sm:mb-0'>
